...
def makeCameraToWorld(cameraShape):
	...
	mc.bakeResults(TempLocator,t=(begin,end),sm=True,sb=1,dic=True,pok=True,sac=False,ral=False,bol=False,mr=True,cp=False,s=True)
	...
	try:
		...
		pass
	mc.bakeResults(CameraTransform,t=(begin,end),sm=True,sb=1,dic=True,pok=True,sac=False,ral=False,bol=False,mr=True,cp=False,s=True)
