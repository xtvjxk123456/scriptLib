...
def run():
    ...
    images_in_project = pm.workspace(en=pm.workspace('images', q=True, fre=True))
    ...
    # 这里有个bug在ffmpeg里
    convertcmd = '{} -apply_trc iec61966_2_1 -start_number 1001 -f image2 -r 24 -i {} -vcodec h264 -vframes {} -preset veryslow -qp 0 {}'.format(mmfpeg,
                                                                                                              seqfile,
                                                                                                              framenum,
                                                                                                              movfile)
